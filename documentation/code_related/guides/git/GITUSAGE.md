...
# User Manual for Pushing Changes to `SEMESTER20##-BA5200-TEAM#` Branch on GitHub
...
This guide will walk you through the steps to push your code changes to the `SEMESTER20##-BA5200-TEAM#` branch.
...
## **3. Working on the `SEMESTER20##-BA5200-TEAM#` Branch**
### Step 1: Check Out the `SEMESTER20##-BA5200-TEAM#` Branch
By default, you might be on the `main` or `master` branch. To switch to the `SEMESTER20##-BA5200-TEAM#` branch, use:
```bash
git checkout SEMESTER20##-BA5200-TEAM#
```
...
git branch
```
which should give you SEMESTER20##-BA5200-TEAM# as response

### Step 2: Make Your Changes
Now that you're on the `SEMESTER20##-BA5200-TEAM#` branch, make your changes to the project files on your computer.
...
```bash
git push origin SEMESTER20##-BA5200-TEAM#
```
This uploads the changes to the `SEMESTER20##-BA5200-TEAM#` branch on GitHub.
...
```bash
git pull origin SEMESTER20##-BA5200-TEAM#
```
...
## **9. Conclusion**
Now you’re ready to push your changes to the `SEMESTER20##-BA5200-TEAM#` branch on GitHub! With GitHub and Git, you can easily collaborate with our team, track progress, and manage code changes efficiently.
