...
from .views.model_training_workflow import stream_training_workflow_output, train_model_workflow, model_stats_workflow, stop_training_workflow
...
urlpatterns = [
    ...
    path('stop_training/', stop_training_workflow, name='stop-training'),
